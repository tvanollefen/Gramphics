...
const unsigned int testSquareAttribs[20] = { demo::A_POSITION, demo::A_COLOR0 };
...
int initGame()
{
	...
	const float colours[] =
	{
		1.0f, 1.0f, 1.0f,
		0.0f, 0.0f, 0.0f,		// grey
		1.0f, 0.0f, 0.0f,		// pale red
		0.0f, 1.0f, 0.0f,		// pale green
		0.0f, 0.0f, 1.0f,		// pale yellow
	};
...
//	testSquareInterleavedVBO = demo::createInterleavedVBO(4, 2, allAttribData);
	...
	testSquareVAO = demo::createVAO(5, 2, allAttribData, testSquareAttribs, &testSquareInterleavedVBO);
